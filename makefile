...
exe/game: obj/main.o obj/button.o obj/character.o obj/fastObstacle.o obj/game.o obj/controls.o obj/mediumObstacle.o obj/menu.o obj/obstacle.o obj/play.o obj/row.o obj/skins.o obj/slowObstacle.o | exe
	$(CC) $(FLAGS) $^ -o $@ $(LDFLAGS)
...
obj/main.o: src/main.cpp hdr/button.hpp hdr/character.hpp hdr/fastObstacle.hpp hdr/game.hpp hdr/controls.hpp hdr/mediumObstacle.hpp hdr/menu.hpp hdr/obstacle.hpp hdr/play.hpp hdr/row.hpp hdr/skins.hpp hdr/slowObstacle.hpp | obj
	$(CC) $(FLAGS) -c $< -o $@
